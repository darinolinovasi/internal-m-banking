...
import { Animated, Modal, Pressable, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
            ...
            <View style={styles.accountCard}>
              ...
              >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <Text style={styles.accountNumberLabel}>{t('rekening')}: <Text style={styles.accountNumber}>2000100101</Text></Text>
                  <TouchableOpacity>
                ...
                <View style={styles.balanceRow}>
                  <View>
                    ...
                    <Text style={styles.balanceValue}>
                      {
                        accountLoading ? t('loading') :
                          (
                            showBalance
                              ? `${account?.accountInfos[0].availableBalance.currency} ${Number(account?.accountInfos[0].availableBalance.value).toLocaleString('id-ID')}`
                              : '***********************'
                          )
                      }
                    </Text>
