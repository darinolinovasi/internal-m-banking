        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#001F3F' }}>
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                    <Text style={styles.sectionTitle}>Transaksi Sebelumnya</Text>
                    {/* Date Group */}
                    <Text style={styles.dateLabel}>Senin, 1 Jan 2000</Text>
                    <View style={styles.card}>
                        <View style={styles.cardLeft}>
                            <Text style={styles.cardName}>Alif Firdi</Text>
                            <TouchableOpacity>
                                <Text style={styles.cardBank}>Transfer Bank</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.cardRight}>
                            <Text style={styles.cardAmount}>IDR 600,000.00</Text>
                            <Text style={styles.cardStatus}>Berhasil</Text>
                        </View>
                    </View>
                    <View style={styles.card}>
                        <View style={styles.cardLeft}>
